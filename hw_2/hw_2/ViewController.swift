...
private extension ViewController {
    ...
    @objc func tap1() {
        ...
        let viewController1 = UINavigationController(rootViewController: ViewController1())
        let viewController2 = UINavigationController(rootViewController: ViewController2())
